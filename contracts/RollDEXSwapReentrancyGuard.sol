 ...
 */
abstract contract RollDEXSwapReentrancyGuard {
    ...
    modifier onlyDuringSwap() {
        require(_swapStatus == _SWAP_IN_PROGRESS, "RollDEX: not allowed outside of swap");
        _;
    }

    function _beforeSwap() private {
        require(_swapStatus != _SWAP_IN_PROGRESS, "RollDEX: reentrant swap not allowed");
